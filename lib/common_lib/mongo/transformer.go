...
func (this *BaseTransformer) GetOrmTransformer(q *orm.Query, t Transformer) *TransformerFunc {
	...
	f := TransformerFunc(func(result orm.OneResult) orm.OneResult {
