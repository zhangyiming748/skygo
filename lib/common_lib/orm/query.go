...
func NewSorter(field string, direction int) *Sorter {
	return &Sorter{
		field:     field,
		direction: direction,
	}
...
func (q *Query) AndWhereGte(field string, value interface{}) *Query {
	c := &Condition{
		...
		field:    field,
		value:    value,
		operator: OperatorIsGreaterThanOrEqual,
	}
	q.AddCondition(c)
	return q
}
...
func (q *Query) AndWhereLte(field string, value interface{}) *Query {
	c := &Condition{
		...
		field:    field,
		value:    value,
		operator: OperatorIsLessThanOrEqual,
	}
	q.AddCondition(c)
	return q
}
...
func (q *Query) AndWhereLike(field string, value interface{}) *Query {
	c := &Condition{
		...
		field:    field,
		value:    value,
		operator: OperatorIsLike,
	}
	q.AddCondition(c)
	return q
}

func (q *Query) AndWhereNotLike(field string, value interface{}) *Query {
	c := &Condition{
		ctype:    CTYPE_AND,
		field:    field,
		value:    value,
		operator: OperatorIsNotLike,
	}
	q.AddCondition(c)
	return q
}
