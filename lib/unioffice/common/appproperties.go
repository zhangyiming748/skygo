...
import (
	...
	"skygo_detection/lib/unioffice/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("skygo_detection/lib/unioffice")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to skygo_detection/lib/unioffice
