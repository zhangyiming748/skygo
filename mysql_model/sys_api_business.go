...
func ApiBusinessGetWhere(params map[string]interface{}) *xorm.Session {
...
func ApiBusinessFetchIdByUrl(url, method string) int {
	api := new(SysApi)
...
func (this SysApiBusiness) GetApiTreeList() (*qmap.QM, error) {
	httpApi := qmap.QM{}
	rpcApi := qmap.QM{}
...
func (this SysApiBusiness) GetApiList(apiType, resource string) ([]SysApiBusiness, error) {
	models := make([]SysApiBusiness, 0)
