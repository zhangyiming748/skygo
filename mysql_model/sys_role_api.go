...
func ApiRoleGetWhere(params map[string]interface{}) *xorm.Session {
...
func (this SysRoleApi) CheckPrivilege(roleId int64, url, method string) bool {
...
func (this SysRoleApi) GetRoleApi(roleId int) []int {
	roleApi := []int{}
...
func (this SysRoleApi) UpdateRoleApi(roleId int, privileges []int) error {
	{
